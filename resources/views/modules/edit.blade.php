<x-app-layout>
    ...
    <x-slot:title>Editer le module</x-slot:title>
                    ...
                    <div class="w-full space-y-4">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <input type="text" name="nom" id="nom" class="block w-full pr-10 sm:text-base rounded-md focus:outline-none @error('nom') focus:ring-red-500 focus:border-red-500 border-red-300 text-red-900 placeholder-red-300 @enderror" placeholder="Nom de votre module" aria-invalid="true" aria-describedby="erreur-nom" value="{{ old('nom') ? old('nom') : $module->nom }}">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative flex">
                                <div class="flex items-center me-4">
                                    <input id="type-{{ $type->id }}" type="radio" value="{{ $type->id }}" name="type" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ $module->type_mesure_id === $type->id ? 'checked' : '' }} @checked(( old('type')===(string) $type->id ))>
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative flex">
                                <div class="flex items-center me-4">
                                    <input id="etat-arret" type="radio" value="0" name="etat" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ $module->etat_marche === 0 ? 'checked' : '' }} @checked((old('etat')==='0' ))>
                                    <label for="etat-arret" class="ms-2 text-sm font-medium text-gray-700 dark:text-gray-300">En arret</label>
                                </div>
                                <div class="flex items-center me-4">
                                    <input id="etat-marche" type="radio" value="1" name="etat" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ $module->etat_marche === 1 ? 'checked' : '' }} @checked((old('etat')==='1' ))>
                                    <label for="etat-marche" class="ms-2 text-sm font-medium text-gray-700 dark:text-gray-300">En marche</label>
                                </div>
                                <div class="flex items-center me-4">
                                    <input id="etat-panne" type="radio" value="2" name="etat" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" {{ $module->etat_marche === 2 ? 'checked' : '' }} @checked((old('etat')==='2' ))>
