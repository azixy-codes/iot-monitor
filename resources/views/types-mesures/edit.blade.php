<x-app-layout>
    ...
    <x-slot:title>Editer le type de mesure</x-slot:title>

    <div class="max-w-xl mx-auto my-6 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <form action="{{ route('types_mesures.update', $type->id) }}" method="POST">
                @csrf
                @method('PUT')
